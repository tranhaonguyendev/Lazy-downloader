...
function parseArgs(argv) {
    ...
    for (let i = 0; i < args.length; i += 1) {
        ...
        if (a === "-h" || a === "--help")
            ...
            out.timeout = Number(need()) || out.timeout;
        else if (a === "--retries")
            out.retries = Number(need()) || out.retries;
            ...
            out.noPretty = true;
        else if (a === "--no-print-json")
            out.noPrintJson = true;
        else if (a === "--quiet")
            out.quiet = true;
        else if (a === "--stdin")
            out.stdin = true;
...
async function runOne(worker, u, args) {
